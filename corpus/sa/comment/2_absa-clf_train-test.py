...
origin_dict = {
    'frying-pan':{'p-e-type': '炸锅类型', 'p-e-cleaning': '清洗', 'p-e-fittings': '配件', 'p-e-operation': '操作', 'p-e-function': '炸锅功能', 'p-e-visualization': '可视化', 'p-e-effect': '炸锅效果', 'p-e-sound': '运转音', 'p-e-packing': '包装', 'p-e-screen': '显示', 'p-e-size': '尺寸', 'p-e-pricematch': '价保', 'p-e-relatedcategories': '关联品类', 'p-c-loyalty': '商品复购', 'p-c-use': '商品用途', 'p-c-price': '商品价格', 'p-c-quality': '商品质量', 'p-c-color': '商品颜色', 'p-c-appearance': '商品外观', 'p-c-marketing': '商品营销', 'p-c-brand': '商品品牌', 'p-c-origin': '商品产地', 'p-c-others': '商品其他', 'cs-c-attitude': '客服态度', 'cs-c-handling': '客服处理速度', 'cs-c-others': '客服其他', 'l-c-delivery': '配送速度', 'l-c-attitude': '物流态度', 'l-c-others': '物流其他', 's-c-maintanence': '维修服务', 's-c-return': '退货服务', 's-c-exchange': '换货服务', 's-c-warranty': '质保', 's-c-refund': '退款服务', 's-c-others': '售后其他'},
    'vacuum-cleaner':{'p-e-type': '吸尘器类型', 'p-e-mode': '运行模式', 'p-e-sucker': '吸头/吸嘴/刷头', 'p-e-fittings': '配件', 'p-e-function': '智能功能', 'p-e-effect': '效果', 'p-e-strainer': '滤芯滤网', 'p-e-charge': '充电', 'p-e-endurance': '续航', 'p-e-power': '吸力', 'p-e-sound': '运转音', 'p-e-packing': '包装', 'p-e-screen': '显示', 'p-e-size': '尺寸', 'p-e-pricematch': '价保', 'p-e-use': '商品用途', 'p-e-environment': '商品使用环境场景', 'p-c-loyalty': '商品复购', 'p-c-price': '商品价格', 'p-c-quality': '商品质量', 'p-c-color': '商品颜色', 'p-c-appearance': '商品外观', 'p-c-marketing': '商品营销', 'p-c-brand': '商品品牌', 'p-c-origin': '商品产地', 'p-c-others': '商品其他', 'cs-c-attitude': '客服态度', 'cs-c-handling': '客服处理速度', 'cs-c-others': '客服其他', 'l-c-delivery': '配送速度', 'l-c-attitude': '物流态度', 'l-c-others': '物流其他', 's-c-maintanence': '维修服务', 's-c-return': '退货服务', 's-c-exchange': '换货服务', 's-c-warranty': '质保', 's-c-refund': '退款服务', 's-c-others': '售后其他'},
    'electric-toothbrush':{'p-e-type': '牙刷类型', 'p-e-mode': '刷牙模式', 'p-e-brush head': '刷头', 'p-e-fittings': '配件', 'p-e-function': '智能功效', 'p-e-basefunction': '牙刷功能', 'p-e-effect': '刷牙效果', 'p-e-charge': '充电', 'p-e-endurance': '续航', 'p-e-power': '动力', 'p-e-sound': '运转音', 'p-e-packing': '包装', 'p-e-screen': '显示', 'p-e-size': '尺寸', 'p-e-pricematch': '价保', 'p-c-loyalty': '商品复购', 'p-c-use': '商品用途', 'p-c-price': '商品价格', 'p-c-quality': '商品质量', 'p-c-color': '商品颜色', 'p-c-appearance': '商品外观', 'p-c-marketing': '商品营销', 'p-c-brand': '商品品牌', 'p-c-origin': '商品产地', 'p-c-others': '商品其他', 'cs-c-attitude': '客服态度', 'cs-c-handling': '客服处理速度', 'cs-c-others': '客服其他', 'l-c-delivery': '配送速度', 'l-c-attitude': '物流态度', 'l-c-others': '物流其他', 's-c-maintanence': '维修服务', 's-c-return': '退货服务', 's-c-exchange': '换货服务', 's-c-warranty': '质保', 's-c-refund': '退款服务', 's-c-others': '售后其他'},
    'shaver':{'p-e-mode': '剃须方式', 'p-e-fittings': '配件', 'p-e-blade': '刀头刀片', 'p-e-cleaning': '清洁方式', 'p-e-effect': '剃须效果', 'p-e-charge': '充电', 'p-e-endurance': '续航', 'p-e-sound': '运转音', 'p-e-packing': '包装', 'p-e-screen': '显示', 'p-e-size': '尺寸', 'p-e-pricematch': '价保', 'p-c-loyalty': '商品复购', 'p-c-use': '商品用途', 'p-c-price': '商品价格', 'p-c-quality': '商品质量', 'p-c-color': '商品颜色', 'p-c-appearance': '商品外观', 'p-c-marketing': '商品营销', 'p-c-brand': '商品品牌', 'p-c-origin': '商品产地', 'p-c-others': '商品其他', 'cs-c-attitude': '客服态度', 'cs-c-handling': '客服处理速度', 'cs-c-others': '客服其他', 'l-c-delivery': '配送速度', 'l-c-attitude': '物流态度', 'l-c-others': '物流其他', 's-c-maintanence': '维修服务', 's-c-return': '退货服务', 's-c-exchange': '换货服务', 's-c-warranty': '质保', 's-c-refund': '退款服务', 's-c-others': '售后其他'},
    'air-purifier':{'p-e-light': '指示灯', 'p-e-smell': '味道', 'p-e-sound': '运转音', 'p-e-purification': '净化效果', 'p-e-effect': '风量', 'p-e-power': '电源', 'p-e-size': '尺寸', 'p-e-induction': '感应', 'p-e-design': '设计', 'p-e-strainer': '滤芯滤网', 'p-e-pattern': '模式', 'p-e-operation': '操作', 'p-e-packing': '包装', 'p-e-screen': '显示', 'p-e-function': '功能', 'p-e-pricematch': '价保', 'p-e-invoice': '发票', 'p-c-loyalty': '商品复购', 'p-c-gift': '商品用途', 'p-c-price': '商品价格', 'p-c-quality': '商品质量', 'p-c-color': '商品颜色', 'p-c-appearance': '商品外观', 'p-c-marketing': '商品营销', 'p-c-brand': '商品品牌', 'p-c-origin': '商品产地', 'p-c-others': '商品其他', 'cs-c-attitude': '客服态度', 'cs-c-handling': '客服处理速度', 'cs-c-others': '客服其他', 'l-c-delivery': '配送速度', 'l-c-attitude': '物流态度', 'l-c-others': '物流其他', 's-c-maintanence': '维修服务', 's-c-installment': '安装服务', 's-c-return': '退货服务', 's-c-exchange': '换货服务', 's-c-warranty': '质保', 's-c-refund': '退款服务', 's-c-others': '售后其他'}
}
slot_dict = {
    'frying-pan':['p-e-type', 'p-e-cleaning', 'p-e-fittings', 'p-e-operation', 'p-e-function', 'p-e-visualization', 'p-e-effect', 'p-e-sound', 'p-e-packing', 'p-e-screen', 'p-e-size', 'p-e-pricematch', 'p-e-relatedcategories', 'p-c-loyalty', 'p-c-use', 'p-c-price', 'p-c-quality', 'p-c-color', 'p-c-appearance', 'p-c-marketing', 'p-c-brand', 'p-c-origin', 'p-c-others', 'cs-c-attitude', 'cs-c-handling', 'cs-c-others', 'l-c-delivery', 'l-c-attitude', 'l-c-others', 's-c-maintanence', 's-c-return', 's-c-exchange', 's-c-warranty', 's-c-refund', 's-c-others'],
    'vacuum-cleaner':['p-e-type', 'p-e-mode', 'p-e-sucker', 'p-e-fittings', 'p-e-function', 'p-e-effect', 'p-e-strainer', 'p-e-charge', 'p-e-endurance', 'p-e-power', 'p-e-sound', 'p-e-packing', 'p-e-screen', 'p-e-size', 'p-e-pricematch', 'p-e-use', 'p-e-environment', 'p-c-loyalty', 'p-c-price', 'p-c-quality', 'p-c-color', 'p-c-appearance', 'p-c-marketing', 'p-c-brand', 'p-c-origin', 'p-c-others', 'cs-c-attitude', 'cs-c-handling', 'cs-c-others', 'l-c-delivery', 'l-c-attitude', 'l-c-others', 's-c-maintanence', 's-c-return', 's-c-exchange', 's-c-warranty', 's-c-refund', 's-c-others'],
    'electric-toothbrush':[],
    'shaver':['p-e-mode', 'p-e-fittings', 'p-e-blade', 'p-e-cleaning', 'p-e-effect', 'p-e-charge', 'p-e-endurance', 'p-e-sound', 'p-e-packing', 'p-e-screen', 'p-e-size', 'p-e-pricematch', 'p-c-loyalty', 'p-c-use', 'p-c-price', 'p-c-quality', 'p-c-color', 'p-c-appearance', 'p-c-marketing', 'p-c-brand', 'p-c-origin', 'p-c-others', 'cs-c-attitude', 'cs-c-handling', 'cs-c-others', 'l-c-delivery', 'l-c-attitude', 'l-c-others', 's-c-maintanence', 's-c-return', 's-c-exchange', 's-c-warranty', 's-c-refund', 's-c-others'],
    'air-purifier':[]
} 
...
stop_words = ['冲牙', '洗牙', '牙线', '洁牙机', '牙嘴', '喷头', '喷嘴']
def check_line(line):
...
def get_clf_data(text_list, slot_list, mode):
    ...
    for line, slots in zip(text_list, slot_list):
        ...
        for slot in slots: # 遍历所有slot，分别找到aspect slot 和 sentiment slot
            ...
            #elif slot['domain'] in ['product', 'cs', 'logistics', 'service'] and slot['slotname'] in ['p-e-type', 'p-e-mode', 'p-e-brush head', 'p-e-fittings', 'p-e-function', 'p-e-basefunction', 'p-e-effect', 'p-e-charge', 'p-e-endurance', 'p-e-power', 'p-e-sound', 'p-e-packing', 'p-e-screen', 'p-e-size', 'p-e-pricematch', 'p-c-loyalty', 'p-c-use', 'p-c-price', 'p-c-quality', 'p-c-color', 'p-c-appearance', 'p-c-marketing', 'p-c-brand', 'p-c-origin', 'p-c-others', 'cs-c-attitude', 'cs-c-handling', 'cs-c-others', 'l-c-delivery', 'l-c-attitude', 'l-c-others', 's-c-maintanence', 's-c-return', 's-c-exchange', 's-c-warranty', 's-c-refund', 's-c-others']:
            elif slot['domain'] in ['product', 'cs', 'logistics', 'service'] and slot['slotname'] in slot_dict[args.dataset_name]: 
        ...
        if len(aspect_slot_list) == 0: 
            ...
            try:
                ...
                write_data(args.output_dir, line, aspect_slot_list, aspect_polarity, mode) 
            except IndexError:
...
if __name__ == '__main__':
    ...
    convert_dict=origin_dict[args.dataset_name]
    ...
    train_text_list, train_slot_list = read_data_by_folder(args.train_dir)
    test_text_list, test_slot_list = read_data_by_folder(args.test_dir)
    ...
    path = os.path.join(args.dataset_name, "corpus.txt")

    with open(path, mode='w', encoding='utf-8') as f:
        for text in all_text_list:
            f.write(str(text) + '\n')

    print('write corspu to', path)
