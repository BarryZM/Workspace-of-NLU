...
cp 2_convert.txt /export/home/sunhongchao1/1-NLU/Workspace-of-NLU/corpus/sa/comment/air-purifier/label_100test/test.txt
cp 2_convert.txt /export/home/sunhongchao1/1-NLU/Workspace-of-NLU/corpus/sa/comment/air-purifier/label_100test/train.txt
cp 2_convert.txt /export/home/sunhongchao1/1-NLU/Workspace-of-NLU/corpus/sa/comment/air-purifier/label_100test/dev.txt
...
# output data is absa-clf.txt

#########
# CLF 
#########
CUDA_VISIBLE_DEVICES=2 python ../classification/train.py  \
    --dataset_name air-purifier-100-test \
    --model_name bert_cnn \
    --epoch 5 \
    --batch_size 64 \
    --do_test \
