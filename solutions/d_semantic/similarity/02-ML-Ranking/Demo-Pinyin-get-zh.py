...
# seg_list = list(jieba.cut(input_text, cut_all=True))
# print(seg_list)
#
# char_pinyin_list = pin.get_pinyin(input_text).split("-")
# print(char_pinyin_list)
#
# word_pinyin_list = []
# for item in seg_list:
#     word_pinyin_list.append(''.join(pin.get_pinyin(item).split('-')))
#
# print(word_pinyin_list)